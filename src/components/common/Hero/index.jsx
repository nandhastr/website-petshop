        ...
        <>
            ...
            >
                <div className="flex flex-col gap-4 w-[100%] md:w-[75%]">
                    ...
                    <h2 className="text-lg md:text-4xl text-gray-100 ">Solusi lengkap untuk mengelola tugas Anda dengan efisien.</h2>
                ...
                <LearnMoreBox className="mt-6 px-4 border-2 border-[#fff] text-[#fff] uppercase py-2  hover:bg-[#fff] hover:text-[#000] transition-all duration-700 ease-in-out">Pelajari lebih lanjut</LearnMoreBox>
            </div>
        </>
    );
};
